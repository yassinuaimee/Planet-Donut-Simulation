	...
	switch(i){
		...
		case(4):if(argc-2!=5)
						...
						else
						{
							...
							//void print_equal_point(bool is_equal, double p1x, double p1y, double p2x, double p2y);
							
							message_geomod::print_equal_point( point_1 == point_2 , point_1.get_x() , point_1.get_y() , point_2.get_x() , point_2.get_y());
						}
					break;
		case(5):if(argc-2!=6)
						{
						...
						else
						{
							...
							//void print_include_point(bool is_included, double px, double py, double cx, double cy, double radius);
							
							Point point( atof(argv[3] ) , atof(argv[4] ) );
							Point centre( atof(argv[5] ) , atof(argv[6] ) );
							Cercle cercle(centre , atof(argv[7] ));
							
							message_geomod::print_include_point( cercle.point_appartient(point)  , point.get_x() , point.get_y() , cercle.get_centre_x() , cercle.get_centre_y() , cercle.get_rayon() );
						}
					break;	
		case(6):if(argc-2!=7)
						{
					...
					else
					{
						...
						message_geomod::print_intersect( cercle_1.intersection_cercle( cercle_2 ), cercle_1.get_centre_x() , cercle_1.get_centre_y() , cercle_1.get_rayon() , cercle_2.get_centre_x() , cercle_2.get_centre_y() , cercle_2.get_rayon());
